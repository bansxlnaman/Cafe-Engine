...
const Order = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      if (!cafe?.id) {
        toast.error('Café configuration not loaded. Please refresh the page.');
        return;
      }

      // Insert order into database (order_number is auto-generated by trigger)
      ...
      // Use order_number for tracking (human-friendly)
      const orderNumber = data.order_number ? `#${data.order_number}` : data.id.slice(0, 8).toUpperCase();
        ...
        <main className="pt-24 pb-12">
          <div className="container mx-auto px-4">
            <div className="max-w-md mx-auto text-center py-20">
              ...
              <Link to={`/track-order?id=${orderId.replace(/^#/, '')}`} className="mb-6 block">
